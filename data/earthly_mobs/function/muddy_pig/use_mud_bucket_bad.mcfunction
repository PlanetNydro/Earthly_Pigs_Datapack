# remove mud buckets from non-temperate pigs and give it back to the player
execute as @e[predicate=!earthly_mobs:pig/likes_mud_bucket,predicate=earthly_mobs:pig/wearing_mud_bucket] run data merge entity @s {equipment: {saddle:{count: 0, id:"minecraft:air"}}}
